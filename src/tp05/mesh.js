...
mesh.Mesh = function (geometry, material) {
  ...
  this.escalar = [1, 1, 1]
  this.texture = null
  this.meshtextbuffobj = []
  this.image = null
  this.usandoText = true
  this.figurename = 'xx'
  this.colorPicking = []
  ...
  this.setUsandoText = function (usandoText) {
    this.usandoText = usandoText
  }

  this.getUsandoText = function () {
    return this.usandoText
  }
