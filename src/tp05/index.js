...
var foldergui7 = gui.addFolder('Transformar o colorear cubo')
...
var foldergui10 = gui.addFolder('Transformar o colorear esfera')
...
var foldergui13 = gui.addFolder('Transformar o colorear cilindro')
...
var cameraeye = []
scene.meshes[5].material.map = require('./firefox-256x256.png')
scene.meshes[6].material.map = require('./firefox-256x256.png')
