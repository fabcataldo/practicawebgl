...
describe('Bar - OLOO', function () {
  var bar

  beforeEach(function () {
    bar = Object.create(Bar)
    bar.init('some-text', 'some-other')
  })

  it('should be prototype of Foo', function () {
    expect(Foo.isPrototypeOf(bar)).toBeTruthy()
  })

  it('should have defined init', function () {
    expect(bar.init).toBeDefined()
    expect(bar.init).toEqual(jasmine.any(Function))
  })
  ...
  describe('#method()', function () {
    ...
    it('should invoke Foo#method()', function () {
      bar.method()
  ...
  describe('#fooMethod()', function () {
    beforeEach(function () {
      spyOn(Foo, 'fooMethod').and.callThrough()
    })
    ...
    it('should invoke Foo#fooMethod()', function () {
      bar.fooMethod()
      expect(Foo.fooMethod).toHaveBeenCalled()
    })
  })
